"""TEST-ONLY diagnostic: isolated canonical five-project physical-net-wall-v2 benchmark.
...
def test_canonical_five_physical_net_wall_v2_diagnostic(tmp_path: Path) -> None:
    ...
    payload = {
        "diagnostic": "canonical_five_physical_net_wall_v2_isolated",
        "production_sha": "0295896926ddbd13a39b6a9b99ed2ad70193a91b",
