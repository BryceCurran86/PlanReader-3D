...
_BRANCH_BASE_SHA = "5bd671d08c87b8c0c6aaadcbae52c74ce4be9425"
...
def test_semantic_existence_cannot_cross_downstream_firewall() -> None:
    """Attack 11: local existence must not imply any quantity/publication gate."""
    ...
    # No Phase-2 API is allowed to publish deductions, FIRM quantities, commercial
    # output or JobHub output directly. Keep these explicit as a regression
    # firewall if later phases add adjacent methods.
...
def test_redteam_branch_is_bound_to_reviewed_governing_main() -> None:
    """Document the immutable review baseline inside the attack suite."""

    assert _BRANCH_BASE_SHA == "5bd671d08c87b8c0c6aaadcbae52c74ce4be9425"
