...
# Exact merged main this independent #322 validator replays against.
_BRANCH_BASE_SHA = "62a161519e617cdf9ce23069820dbf7c68aaf521"
...
def test_redteam_branch_is_bound_to_reviewed_governing_main() -> None:
    """Document the immutable merged-main baseline inside the attack suite."""

    assert _BRANCH_BASE_SHA == "62a161519e617cdf9ce23069820dbf7c68aaf521"
