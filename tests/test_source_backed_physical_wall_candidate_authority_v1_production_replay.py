"""Replay-only acceptance proof for source-backed physical-wall authority v1."""
...
PRODUCTION_SHA = "082810b541bbe4072376f7328fc6064351cb383c"
...
def test_frozen_source_backed_wall_validator_accepts_exact_production_head() -> None:
    report = run_replay(
        ReplayConfig(
            lane=LaneType.HOST,
            repo_path=Path.cwd(),
