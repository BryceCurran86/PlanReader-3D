...
def test_canonical_five_physical_net_wall_reuse_v4_diagnostic(tmp_path: Path) -> None:
    ...
    payload = {
        "diagnostic": "canonical_five_physical_net_wall_reuse_v4",
        "production_sha": "6e35d6c47b2bde05afc3ae7d2148eba1881603e1",
