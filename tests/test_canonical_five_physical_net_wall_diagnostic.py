"""TEST-ONLY diagnostic: isolated canonical five-project physical-net-wall benchmark.
...
def test_canonical_five_physical_net_wall_diagnostic(tmp_path: Path) -> None:
    ...
    payload = {
        "diagnostic": "canonical_five_physical_net_wall_isolated",
        "production_sha": "3af9224d757e4164b347947a0118d6aec3759d44",
