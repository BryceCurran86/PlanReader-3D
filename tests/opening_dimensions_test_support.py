...
def figure_witness_opening_pdf_bytes(
    *,
    ...
    if with_witness_lines:
        ...
        page.draw_line(fitz.Point(100.0, 70.0), fitz.Point(140.0, 70.0), color=(0, 0, 0), width=0.5)
        page.draw_line(fitz.Point(100.0, 70.0), fitz.Point(100.0, 100.0), color=(0, 0, 0), width=0.5)
        page.draw_line(fitz.Point(140.0, 70.0), fitz.Point(140.0, 100.0), color=(0, 0, 0), width=0.5)
...
def assert_dimension_capability_locked(physical: PhysicalOpeningAuthority | None = None) -> None:
