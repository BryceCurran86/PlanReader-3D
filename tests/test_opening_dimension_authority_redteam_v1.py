...
Base: current post-#331 main e27ffad284b05123ffacbbe123c69823c5367dee.

Production files changed: 0.
Merged opening identity (#331) is a prerequisite and remains out of scope.
...
EXPECTED_RED = pytest.mark.xfail(
    strict=True,
    reason="OpeningDimensionAuthority not implemented on current post-#331 main",
)
...
def test_branch_bound_to_current_post_331_main() -> None:
...
def test_attack_downstream_firewall_after_existence() -> None:
    ...
    assert hasattr(physical, "compare_identity")
    for method in (
...
def test_attack03_height_from_authenticated_elevation_independent() -> None:
    ...
    authority = OpeningDimensionAuthority  # noqa: F841
