"""Replay-only acceptance proof for frozen host-binding V3 vs equivalence-corrected production."""
...
PRODUCTION_SHA = "faec85cb47a8449f93cf8883555b3e68950b5d5d"
...
def test_frozen_host_binding_v3_accepts_equivalence_corrected_production_head() -> None:
    report = run_replay(
        ReplayConfig(
            lane=LaneType.HOST,
            repo_path=Path.cwd(),
