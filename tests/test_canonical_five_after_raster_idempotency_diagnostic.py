"""TEST-ONLY diagnostic: isolated canonical five-project after-raster-idempotency benchmark.
...
def test_canonical_five_after_raster_idempotency_diagnostic(tmp_path: Path) -> None:
    ...
    payload = {
        "diagnostic": "canonical_five_after_raster_idempotency_isolated",
        "production_sha": "413beff37b3aebd58aa1166acc8a37faa55e92b6",
