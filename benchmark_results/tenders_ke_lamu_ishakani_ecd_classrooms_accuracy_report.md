...
- **Evaluation Timestamp**: `2026-09-19T11:23:39.753542+00:00`
- **Evaluation Status**: `scored`
- **Source PDF**: `C:\Users\bryce\Documents\worktrees\schedule-count-accuracy-v1\benchmarks\sources\lamu-ishakani-ecd-classrooms-boq.pdf`

## 1. Executive Headline Metrics

| Metric | Value | Description |
| :--- | :--- | :--- |
| **Overall Accuracy (<= 5% tol)** | **`33.3%`** | Combined exact matches and within 5% tolerance |
| **Strict Exact Accuracy** | **`22.2%`** | Zero-tolerance exact numerical matches only |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `LMU-E3-A` | 200mm thick approved local; machine cut; natural stone walling; bedding, jointing and pointing in cement sand (1:3) mortar | `measurable_from_drawings` | 136.00 | - | SM | - | - | `missed_in_extraction` | Sheet Ground Floor Plan / Elevations (unnumbered) (p. 41) |
| `LMU-E3-B` | Damp proofing: 200mm wide; B.S. 743 Type A bitumen hessian base, 150mm laps (no allowance made for laps); horizontal, 1No. layer, bedded in cement sand (1:3) mortar | `measurable_from_drawings` | 75.00 | 54.50 | LM | -20.50 | 27.3% | `gross_mismatch` | Sheet Ground Floor Plan / Elevations (unnumbered) (p. 41) |
...
| `LMU-E5-A` | 50mm thick double panelled door faced and hardwood lipped all round, overall size 1200 x 2400mm high | `schedule_extractable` | 2.00 | 2.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet Ground Floor Plan / Elevations (unnumbered) (p. 41) |
...
| `LMU-E7-D` | Chalk Board: 3200 x 1500mm wide, 25mm thick blockboard plugged to concrete or blockwork, complete with 50 x 25mm thick chamfered frame all round, 3 coats black bituminous paint | `measurable_from_drawings` | 2.00 | 2.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet Ground Floor Plan / Elevations (unnumbered) (p. 41) |
...
- **`LMU-E3-B`** (Damp proofing: 200mm wide; B.S. 743 Type A bitumen hessian base, 150mm laps (no allowance made for laps); horizontal, 1No. layer, bedded in cement sand (1:3) mortar): Expected `75.0`, Extracted `54.5` (27.3% error). Comparison evaluated against 75.0 LM

## 5. Missed Items

- **`LMU-E3-A`** (200mm thick approved local; machine cut; natural stone walling; bedding, jointing and pointing in cement sand (1:3) mortar): Expected `136.0 SM` on Sheet `Ground Floor Plan / Elevations (unnumbered)`.
