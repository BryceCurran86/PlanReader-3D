...
- **Evaluation Timestamp**: `2026-09-18T19:49:00.219782+00:00`
...
| :--- | :--- | :--- |
| **Overall Accuracy (<= 5% tol)** | **`20.0%`** | Combined exact matches and within 5% tolerance |
...
| `door` | Door door (2 No authenticated from drawing source) | `hallucinated` | - | 2.00 | NO | - | - | `hallucinated_item` | Sheet N/A (p. 41) |
...
- **`door`** (Door door (2 No authenticated from drawing source)): Extracted `2.0 NO` with no corresponding BOQ entry.
