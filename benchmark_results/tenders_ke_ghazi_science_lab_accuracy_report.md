...
- **Evaluation Timestamp**: `2026-09-19T11:23:32.303883+00:00`
- **Evaluation Status**: `scored`
- **Source PDF**: `C:\Users\bryce\Documents\worktrees\schedule-count-accuracy-v1\benchmarks\sources\1739211305954-tender-document-for-construction-of-science-laboratory-at-ghazi-primary-school.pdf`

## 1. Executive Headline Metrics

| Metric | Value | Description |
| :--- | :--- | :--- |
| **Overall Accuracy (<= 5% tol)** | **`53.9%`** | Combined exact matches and within 5% tolerance |
| **Strict Exact Accuracy** | **`30.8%`** | Zero-tolerance exact numerical matches only |
...
| Within 5% Tolerance | `3` | Area/length finishes within 5% tolerance |
...
| `GZ-E3-A` | Bituminous felt damp proof course 190mm thick under all 200mm thick walling | `measurable_from_drawings` | 51.00 | 52.30 | LM | +1.30 | 2.5% | `within_5_percent` | Sheet Design Scheme (Plan) 1 of 3 (p. 167) |
| `GZ-E3-B` | Approved coral block walling in 200mm thick walling externally | `measurable_from_drawings` | 109.00 | - | SM | - | - | `missed_in_extraction` | Sheet Design Scheme (Plan) 1 of 3 (p. 167) |
...
| `GZ-E5-A` | External door overall size 1500 x 2400mm high, unequal double leaf | `schedule_extractable` | 2.00 | 2.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet Design Scheme (Plan) 1 of 3 (p. 167) |
| `GZ-E5-B` | 45mm internal quality flush door overall size 850 x 2120mm shutter | `schedule_extractable` | 3.00 | 3.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet Design Scheme (Plan) 1 of 3 (p. 167) |
| `GZ-E6-D` | Metal casement window overall size 1800 x 1500mm high with 2No openable | `schedule_extractable` | 7.00 | 7.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet Design Scheme (Plan) 1 of 3 (p. 167) |
...
- **`GZ-E3-B`** (Approved coral block walling in 200mm thick walling externally): Expected `109.0 SM` on Sheet `Design Scheme (Plan) 1 of 3`.
