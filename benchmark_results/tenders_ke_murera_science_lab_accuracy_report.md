...
- **Evaluation Timestamp**: `2026-09-24T14:48:40.853640+00:00`
- **Evaluation Status**: `scored`
- **Source PDF**: `C:\Users\bryce\.gemini\antigravity\scratch\PlanReader-3D\benchmarks\sources\1785347143869-bqs-drawings.pdf`

## 1. Executive Headline Metrics

| Metric | Value | Description |
| :--- | :--- | :--- |
| **Overall Accuracy (<= 5% tol)** | **`40.0%`** | Combined exact matches and within 5% tolerance |
| **Strict Exact Accuracy** | **`40.0%`** | Zero-tolerance exact numerical matches only |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `substructure_surface_bed` | 125mm thick reinforced concrete class 25 surface bed | `measurable_from_drawings` | 196.00 | - | SM | - | - | `missed_in_extraction` | Sheet Section A-A / E-E (p. 225) |
| `substructure_bed_dpm` | 1000 gauge polythene damp-proof membrane under bed | `measurable_from_drawings` | 208.00 | - | SM | - | - | `missed_in_extraction` | Sheet Section A-A / E-E (p. 225) |
| `substructure_a142_mesh` | Steel mesh fabric reinforcement Ref A142 in floor bed | `measurable_from_drawings` | 208.00 | - | SM | - | - | `missed_in_extraction` | Sheet Section A-A / E-E (p. 225) |
...
| `doors_complete` | Single flush doors and double steel casement doors | `schedule_extractable` | 5.00 | 5.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet Door Schedule (p. 223) |

## 5. Missed Items

- **`substructure_surface_bed`** (125mm thick reinforced concrete class 25 surface bed): Expected `196.0 SM` on Sheet `Section A-A / E-E`.
- **`substructure_bed_dpm`** (1000 gauge polythene damp-proof membrane under bed): Expected `208.0 SM` on Sheet `Section A-A / E-E`.
- **`substructure_a142_mesh`** (Steel mesh fabric reinforcement Ref A142 in floor bed): Expected `208.0 SM` on Sheet `Section A-A / E-E`.
