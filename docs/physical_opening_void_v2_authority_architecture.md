...
- Host-binding V3 production exists in PR #381 but is not merged yet.
...
The validator foundation is expected-red until those prerequisites exist. Do not
fake them with monkeypatched height, default sill/head, schedule-only values,
