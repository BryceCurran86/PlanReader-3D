...
The elevation viewports themselves print `16000` beside the front and rear dimension lines (text around y 596.7 and 847.5) and `8200` beside the gable line (around y 1066.2). The front vector witnesses are `1917:0` and `1918:0`, with dimension line `1919:0`, at structural x 201.32–654.92. The rear repeats this in `1275:0`–`1277:0`. The gable full-span witnesses are `858:0` and `859:0`, with line `860:0`, at structural x 328.64–561.20. These are source-native structural dimension bundles; none prints a roof-edge extent. They nominate an existing authority-seam investigation, but do not themselves grant roof measurement authority.\n\nThe sheet prints 16,000 mm along the long structural axis and 8,200 mm across the gable structure. Dividing the corresponding vector spans gives 28.350 and 28.361 pt/m (about 0.04% disagreement). Using those ratios solely as a **diagnostic** suggests an outer roof plan length of 17.202 m, width 9.194 m, and area 166.32 m² after pitch. This is not a firm calibration or publishable quantity.
