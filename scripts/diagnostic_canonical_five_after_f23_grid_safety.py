...
PRODUCTION_SHA = "4b023243e8e85230f20b63d59a50e488055b38db"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                url,
                headers={"User-Agent": "PlanReader-canonical-after-f23-grid-safety/1.0"},
            )
...
result = {
    "diagnostic": "canonical_five_after_f23_grid_safety",
    "production_sha": PRODUCTION_SHA,
    "projects": rows,
    "scored_project_count": len(scored),
    "totals": totals,
}
print("CANONICAL_FIVE_AFTER_F23_GRID_SAFETY=" + json.dumps(result, sort_keys=True), flush=True)
