...
PRODUCTION_SHA = "89b24f7c96d38de9f9a942934e95d92b28bd5d2a"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                url,
                headers={"User-Agent": "PlanReader-canonical-after-plan-footprint-authority/1.0"},
            )
...
result = {
    "diagnostic": "canonical_five_after_plan_footprint_authority",
    "production_sha": PRODUCTION_SHA,
    "projects": rows,
    "scored_project_count": len(scored),
    "totals": totals,
}
print("CANONICAL_FIVE_AFTER_PLAN_FOOTPRINT_AUTHORITY=" + json.dumps(result, sort_keys=True), flush=True)
