...
def _source_page_size(
    ...
    *,
    ...
    """Read page dimensions only from the immutable producer-owned source."""
    store = source_visibility_producer._producer._store
    source_bytes = store.source_bytes_by_revision.get(str(revision_id))
